...
func (c *Cdk8sAppProxy) Default(ctx context.Context, obj runtime.Object) error {
	...
	// Set the default poll interval if not specified
...
func (c *Cdk8sAppProxy) ValidateUpdate(ctx context.Context, oldRaw runtime.Object, newObj runtime.Object) (admission.Warnings, error) {
